...
$Events = [
    ...
    [
        "image" => "/src/assets/img/events/iotconcept.png",
        "name" => "",
    ...
    [
        "image" => "/src/assets/img/events/iot5g.png",
        "name" => "",
...
$Collaborations = [
    ...
    [
        "image" => "/src/assets/img/events/pic5.jpeg",
...
function customCard($data)
{
    foreach ($data as $index => $val) {
        $image = !empty($val['image']) ? $val['image'] : '/src/assets/img/Noimage.png';
